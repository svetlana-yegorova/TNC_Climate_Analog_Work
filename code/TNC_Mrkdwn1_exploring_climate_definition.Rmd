...
def_f_nf<-ggplot(data0, aes(x=def_h, color=as.factor(forest)))+
  geom_histogram()+
  labs(title = "Raw Deficit Distribution ", color="Forest/Non-forest")+
  xlab("Deficit")+
  theme_bw()

aet_f_nf<-ggplot(data0, aes(x=aet_h, color=as.factor(forest)))+
  geom_histogram()+
  labs(title = "Raw AET Distribution ", color="Forest/Non-forest")+
  xlab("AET")+
  theme_bw()
...
def_f_nfsq<-ggplot(data0, aes(x=sqrt(def_h), color=as.factor(forest)))+
  geom_histogram()+
  labs(title = "SQRT Deficit Distribution ", color="Forest/Non-forest")+
  xlab("Deficit")+
  theme_bw()

aet_f_nfsq<-ggplot(data0, aes(x=sqrt(aet_h), color=as.factor(forest)))+
  geom_histogram()+
  labs(title = "SQRT AET Distribution ", color="Forest/Non-forest")+
  xlab("AET")+
  theme_bw()
...
together<-ggplot(data0, aes(x=def_h, y=aet_h, color= forest)) +
 ...
 # geom_point(data=subset(data0, forest==1), colour="red", shape=1)+
    labs(title = "Forst & non-forest pixels in the climate space (together)")+
  xlab("Deficit")+
  ylab("AET")+
  theme_bw()
