...
# adopting Sean Parks' code for binned climate analog modeling of future forest 
# loss. 
...
# 4) test function accuracy. 

# 4) write the function for future climate 
...
# saveRDS(xy, "./outputs/XY.rds")
xy<-readRDS("./outputs/XY.rds")
...
saveRDS(xy_sq, "./outputs/xy_sqrt.rds")
